...
namespace Physio.Infrasctructure.Migrations
{
    ...
    [Migration("20240223005111_scheduling-status-enum")]
    partial class schedulingstatusenum
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Physio.Domain.Entities.StatusSchedulingEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 2, 23, 0, 51, 9, 684, DateTimeKind.Utc).AddTicks(5786),
                            IsDeleted = false,
                            Name = "Cancelado",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 23, 0, 51, 9, 684, DateTimeKind.Utc).AddTicks(5791),
                            IsDeleted = false,
                            Name = "Finalizado",
                            Status = 2
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 23, 0, 51, 9, 684, DateTimeKind.Utc).AddTicks(5793),
                            IsDeleted = false,
                            Name = "Remarcado",
                            Status = 3
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 23, 0, 51, 9, 684, DateTimeKind.Utc).AddTicks(5840),
                            IsDeleted = false,
                            Name = "Agendado",
                            Status = 4
                        });
