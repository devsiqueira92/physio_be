...
namespace Physio.Infrasctructure.Migrations
{
    ...
    [Migration("20240312160802_clinic-scheduling")]
    partial class clinicscheduling
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Physio.Domain.Entities.StatusSchedulingEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 3, 12, 16, 8, 0, 272, DateTimeKind.Utc).AddTicks(7350),
                            IsDeleted = false,
                            Name = "Cancelado",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 3, 12, 16, 8, 0, 272, DateTimeKind.Utc).AddTicks(7354),
                            IsDeleted = false,
                            Name = "Finalizado",
                            Status = 2
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 3, 12, 16, 8, 0, 272, DateTimeKind.Utc).AddTicks(7366),
                            IsDeleted = false,
                            Name = "Remarcado",
                            Status = 3
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 3, 12, 16, 8, 0, 272, DateTimeKind.Utc).AddTicks(7368),
                            IsDeleted = false,
                            Name = "Agendado",
                            Status = 4
                        });
