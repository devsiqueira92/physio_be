...
namespace Physio.Infrasctructure.Migrations
{
    ...
    [Migration("20240224172548_clinic-table-user-contraints")]
    partial class clinictableusercontraints
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Physio.Domain.Entities.StatusSchedulingEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 2, 24, 17, 25, 47, 751, DateTimeKind.Utc).AddTicks(2643),
                            IsDeleted = false,
                            Name = "Cancelado",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 24, 17, 25, 47, 751, DateTimeKind.Utc).AddTicks(2646),
                            IsDeleted = false,
                            Name = "Finalizado",
                            Status = 2
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 24, 17, 25, 47, 751, DateTimeKind.Utc).AddTicks(2660),
                            IsDeleted = false,
                            Name = "Remarcado",
                            Status = 3
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 24, 17, 25, 47, 751, DateTimeKind.Utc).AddTicks(2663),
                            IsDeleted = false,
                            Name = "Agendado",
                            Status = 4
                        });
