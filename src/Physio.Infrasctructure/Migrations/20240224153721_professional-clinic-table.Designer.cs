...
namespace Physio.Infrasctructure.Migrations
{
    ...
    [Migration("20240224153721_professional-clinic-table")]
    partial class professionalclinictable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Physio.Domain.Entities.StatusSchedulingEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 2, 24, 15, 37, 20, 830, DateTimeKind.Utc).AddTicks(4213),
                            IsDeleted = false,
                            Name = "Cancelado",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 24, 15, 37, 20, 830, DateTimeKind.Utc).AddTicks(4216),
                            IsDeleted = false,
                            Name = "Finalizado",
                            Status = 2
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 24, 15, 37, 20, 830, DateTimeKind.Utc).AddTicks(4277),
                            IsDeleted = false,
                            Name = "Remarcado",
                            Status = 3
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 24, 15, 37, 20, 830, DateTimeKind.Utc).AddTicks(4292),
                            IsDeleted = false,
                            Name = "Agendado",
                            Status = 4
                        });
