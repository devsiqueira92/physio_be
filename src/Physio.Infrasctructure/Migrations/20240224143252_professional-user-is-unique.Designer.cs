...
namespace Physio.Infrasctructure.Migrations
{
    ...
    [Migration("20240224143252_professional-user-is-unique")]
    partial class professionaluserisunique
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Physio.Domain.Entities.StatusSchedulingEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 2, 24, 14, 32, 50, 912, DateTimeKind.Utc).AddTicks(1987),
                            IsDeleted = false,
                            Name = "Cancelado",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 24, 14, 32, 50, 912, DateTimeKind.Utc).AddTicks(1991),
                            IsDeleted = false,
                            Name = "Finalizado",
                            Status = 2
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 24, 14, 32, 50, 912, DateTimeKind.Utc).AddTicks(2003),
                            IsDeleted = false,
                            Name = "Remarcado",
                            Status = 3
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 24, 14, 32, 50, 912, DateTimeKind.Utc).AddTicks(2005),
                            IsDeleted = false,
                            Name = "Agendado",
                            Status = 4
                        });
