...
namespace Physio.Infrasctructure.Migrations
{
    ...
    [Migration("20240224134002_user-to-professional")]
    partial class usertoprofessional
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Physio.Domain.Entities.StatusSchedulingEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 2, 24, 13, 40, 1, 435, DateTimeKind.Utc).AddTicks(8951),
                            IsDeleted = false,
                            Name = "Cancelado",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 24, 13, 40, 1, 435, DateTimeKind.Utc).AddTicks(8954),
                            IsDeleted = false,
                            Name = "Finalizado",
                            Status = 2
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 24, 13, 40, 1, 435, DateTimeKind.Utc).AddTicks(8956),
                            IsDeleted = false,
                            Name = "Remarcado",
                            Status = 3
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 24, 13, 40, 1, 435, DateTimeKind.Utc).AddTicks(8958),
                            IsDeleted = false,
                            Name = "Agendado",
                            Status = 4
                        });
