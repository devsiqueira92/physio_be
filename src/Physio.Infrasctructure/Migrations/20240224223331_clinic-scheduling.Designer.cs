...
namespace Physio.Infrasctructure.Migrations
{
    ...
    [Migration("20240224223331_clinic-scheduling")]
            ...
            modelBuilder.Entity("Physio.Domain.Entities.StatusSchedulingEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 2, 24, 22, 33, 31, 495, DateTimeKind.Utc).AddTicks(584),
                            IsDeleted = false,
                            Name = "Cancelado",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 24, 22, 33, 31, 495, DateTimeKind.Utc).AddTicks(588),
                            IsDeleted = false,
                            Name = "Finalizado",
                            Status = 2
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 24, 22, 33, 31, 495, DateTimeKind.Utc).AddTicks(590),
                            IsDeleted = false,
                            Name = "Remarcado",
                            Status = 3
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 24, 22, 33, 31, 495, DateTimeKind.Utc).AddTicks(592),
                            IsDeleted = false,
                            Name = "Agendado",
                            Status = 4
                        });
