...
namespace Physio.Infrasctructure.Migrations
{
    ...
    [Migration("20240226203918_clinic-removing-contact-address-column")]
    partial class clinicremovingcontactaddresscolumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Physio.Domain.Entities.StatusSchedulingEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 2, 26, 20, 39, 18, 139, DateTimeKind.Utc).AddTicks(2892),
                            IsDeleted = false,
                            Name = "Cancelado",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 26, 20, 39, 18, 139, DateTimeKind.Utc).AddTicks(2896),
                            IsDeleted = false,
                            Name = "Finalizado",
                            Status = 2
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 26, 20, 39, 18, 139, DateTimeKind.Utc).AddTicks(2907),
                            IsDeleted = false,
                            Name = "Remarcado",
                            Status = 3
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 26, 20, 39, 18, 139, DateTimeKind.Utc).AddTicks(2910),
                            IsDeleted = false,
                            Name = "Agendado",
                            Status = 4
                        });
