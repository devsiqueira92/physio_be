...
namespace Physio.Infrasctructure.Migrations
{
    ...
    [Migration("20240224164645_clinic-table")]
            ...
            modelBuilder.Entity("Physio.Domain.Entities.StatusSchedulingEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 2, 24, 16, 46, 45, 556, DateTimeKind.Utc).AddTicks(7460),
                            IsDeleted = false,
                            Name = "Cancelado",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 24, 16, 46, 45, 556, DateTimeKind.Utc).AddTicks(7463),
                            IsDeleted = false,
                            Name = "Finalizado",
                            Status = 2
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 24, 16, 46, 45, 556, DateTimeKind.Utc).AddTicks(7474),
                            IsDeleted = false,
                            Name = "Remarcado",
                            Status = 3
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 24, 16, 46, 45, 556, DateTimeKind.Utc).AddTicks(7476),
                            IsDeleted = false,
                            Name = "Agendado",
                            Status = 4
                        });
