...
namespace Physio.Infrasctructure.Migrations
{
    ...
    [Migration("20240229123309_professional-patient-table")]
    partial class professionalpatienttable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Physio.Domain.Entities.StatusSchedulingEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 2, 29, 12, 33, 7, 851, DateTimeKind.Utc).AddTicks(2653),
                            IsDeleted = false,
                            Name = "Cancelado",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 29, 12, 33, 7, 851, DateTimeKind.Utc).AddTicks(2657),
                            IsDeleted = false,
                            Name = "Finalizado",
                            Status = 2
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 29, 12, 33, 7, 851, DateTimeKind.Utc).AddTicks(2659),
                            IsDeleted = false,
                            Name = "Remarcado",
                            Status = 3
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 29, 12, 33, 7, 851, DateTimeKind.Utc).AddTicks(2661),
                            IsDeleted = false,
                            Name = "Agendado",
                            Status = 4
                        });
