...
namespace Physio.Infrasctructure.Migrations
{
    ...
    [Migration("20240314103944_updating-scheduling-type-column-name")]
    partial class updatingschedulingtypecolumnname
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Physio.Domain.Entities.StatusSchedulingEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 3, 14, 10, 39, 43, 65, DateTimeKind.Utc).AddTicks(5950),
                            IsDeleted = false,
                            Name = "Cancelado",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 3, 14, 10, 39, 43, 65, DateTimeKind.Utc).AddTicks(5954),
                            IsDeleted = false,
                            Name = "Finalizado",
                            Status = 2
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 3, 14, 10, 39, 43, 65, DateTimeKind.Utc).AddTicks(5955),
                            IsDeleted = false,
                            Name = "Remarcado",
                            Status = 3
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 3, 14, 10, 39, 43, 65, DateTimeKind.Utc).AddTicks(5958),
                            IsDeleted = false,
                            Name = "Agendado",
                            Status = 4
                        });
