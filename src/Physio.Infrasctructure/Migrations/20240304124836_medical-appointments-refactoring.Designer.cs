...
namespace Physio.Infrasctructure.Migrations
{
    ...
    [Migration("20240304124836_medical-appointments-refactoring")]
    partial class medicalappointmentsrefactoring
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Physio.Domain.Entities.ClinicSchedulingEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("ID");
                    ...
                    b.ToTable("TB_CLINIC_SCHEDULING", (string)null);
                });
            ...
            modelBuilder.Entity("Physio.Domain.Entities.MedicalAppointmentEntity", b =>
                {
                    ...
                    b.Property<Guid?>("ClinicSchedulingId")
                        .IsRequired()
                        .HasMaxLength(36)
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<Guid?>("ProfessionalSchedulingId")
                        .IsRequired()
                        .HasMaxLength(36)
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("ClinicSchedulingId");

                    b.HasIndex("ProfessionalSchedulingId");
            ...
            modelBuilder.Entity("Physio.Domain.Entities.ProfessionalSchedulingEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("ID");
                    ...
                    b.ToTable("TB_PROFESSIONAL_SCHEDULING", (string)null);
                });
            ...
            modelBuilder.Entity("Physio.Domain.Entities.SchedulingTypeEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("ID");
                    ...
                    b.ToTable("TB_SCHEDULING_TYPE", (string)null);
                });
            ...
            modelBuilder.Entity("Physio.Domain.Entities.StatusSchedulingEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 3, 4, 12, 48, 35, 330, DateTimeKind.Utc).AddTicks(9237),
                            IsDeleted = false,
                            Name = "Cancelado",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 3, 4, 12, 48, 35, 330, DateTimeKind.Utc).AddTicks(9241),
                            IsDeleted = false,
                            Name = "Finalizado",
                            Status = 2
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 3, 4, 12, 48, 35, 330, DateTimeKind.Utc).AddTicks(9243),
                            IsDeleted = false,
                            Name = "Remarcado",
                            Status = 3
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 3, 4, 12, 48, 35, 330, DateTimeKind.Utc).AddTicks(9244),
                            IsDeleted = false,
                            Name = "Agendado",
                            Status = 4
                        });
            ...
            modelBuilder.Entity("Physio.Domain.Entities.MedicalAppointmentEntity", b =>
                {
                    b.HasOne("Physio.Domain.Entities.ClinicSchedulingEntity", "ClinicSchedulingEntity")
                        .WithMany()
                        .HasForeignKey("ClinicSchedulingId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Physio.Domain.Entities.ProfessionalSchedulingEntity", "ProfessionalSchedulingEntity")
                        .WithMany()
                        .HasForeignKey("ProfessionalSchedulingId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("ClinicSchedulingEntity");

                    b.Navigation("ProfessionalSchedulingEntity");
                });
