...
namespace Physio.Infrasctructure.Migrations
{
    ...
    [Migration("20240224172420_user-id-clinic-table")]
    partial class useridclinictable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Physio.Domain.Entities.StatusSchedulingEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 2, 24, 17, 24, 18, 287, DateTimeKind.Utc).AddTicks(4708),
                            IsDeleted = false,
                            Name = "Cancelado",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 24, 17, 24, 18, 287, DateTimeKind.Utc).AddTicks(4714),
                            IsDeleted = false,
                            Name = "Finalizado",
                            Status = 2
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 24, 17, 24, 18, 287, DateTimeKind.Utc).AddTicks(4717),
                            IsDeleted = false,
                            Name = "Remarcado",
                            Status = 3
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 2, 24, 17, 24, 18, 287, DateTimeKind.Utc).AddTicks(4721),
                            IsDeleted = false,
                            Name = "Agendado",
                            Status = 4
                        });
